"""Alert Handler - Coordinates LoRa alerts"""
import logging
import os
...
class AlertHandler:
    """Simple alert coordinator for LoRa"""

    def __init__(self, lora, rtc, config):
        """
    ...
    def send_alert(self, detection, image=None):
        ...
        # Check cooldown before LoRa/email alerts
...
if __name__ == "__main__":
    ...
    handler = AlertHandler(lora, rtc, config)
